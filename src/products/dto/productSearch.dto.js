...
var ProductSearchDto = /** @class */ (function (_super) {
    __extends(ProductSearchDto, _super);
    function ProductSearchDto() {
    ...
    ], ProductSearchDto.prototype, "categoryId");
    __decorate([
        (0, swagger_1.ApiProperty)({ required: false }),
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsPositive)()
    ], ProductSearchDto.prototype, "search");
