...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var PORT, fastifyAdapter, app, config, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    PORT = process.env.PORT || 3000;
                    fastifyAdapter = new platform_fastify_1.FastifyAdapter();
                    return [4 /*yield*/, core_1.NestFactory.create(app_module_1.AppModule, fastifyAdapter)];
                case 1:
                    app = _a.sent();
                    app.useGlobalFilters(new http_exception_filter_1.HttpExceptionFilter());
                    //app.useGlobalPipes(new ValidationPipe());
                    return [4 /*yield*/, app.register(fastify_helmet_1["default"], {
